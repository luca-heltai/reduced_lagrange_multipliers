...
//			const SymmetricTensor< 2, dim, NumberType> I (Physics::Elasticity::StandardTensors<dim>::I);
//			std::array< std::pair< NumberType, Tensor< 1, dim, NumberType > >, dim >
//			eigen_I = eigenvectors(I, this->eigen_solver);
//			eigen_I[0].second[0] = 1; eigen_I[0].second[1] = 0; eigen_I[0].second[2] = 0;
//			eigen_I[1].second[0] = 0; eigen_I[1].second[1] = 1; eigen_I[1].second[2] = 0;
//			eigen_I[2].second[0] = 0; eigen_I[2].second[1] = 0; eigen_I[2].second[2] = 1;
			...
			for (unsigned int a = 0; a < dim; ++a) {
				SymmetricTensor<2, dim, NumberType> ev_basis = symmetrize(outer_product(eigen_b[a].second,eigen_b[a].second));
				//SymmetricTensor<2, dim, NumberType> ev_basis_I = symmetrize(outer_product(eigen_I[a].second,eigen_I[a].second));
...
//						<< std::setw(16) << ev_basis_I[2][2] << "," << std::endl;

...
for j in range(len(numVess)):
    ...
    PExt_file=np.loadtxt(dataDirectory+"PresVess3D_"+numVess[j]+"Cell0_k_0dt"+dt+"_omega_1DXmax1kmRef1.txt")
    Pres_file=np.loadtxt(dataDirectory+"PresEXTVess3D_"+numVess[j]+"Cell0_k_0dt"+dt+"_omega_1DXmax1kmRef1.txt")
...
plt.savefig(directory+"graphs.png")
